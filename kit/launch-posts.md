...
## A. The hub launch (Farcaster / X - via Firefly)

> We just put the ZAO Fund for Emerging Culture in one place.
>
> 32 artists and builders, backed by our community match fund on Artizen. Browse them, see a different
...
## B. The Festivals umbrella (Farcaster / X)

> Introducing ZAO Festivals - our home for live culture.
>
> Music festivals, concerts, and artist-led real-world activations, backed by the community so organizers
...
> Two asks:
> 1. Share the link.
> 2. Collect 2-3 projects you love - it unlocks the fund's match for them. Drive ends [date].
...
> straight to them. The hub puts all 32 projects in one place, features a new one each day, and shows the
> aligned funds we work alongside.
>
> We are also launching ZAO Festivals - a fund for music festivals and artist-led real-world activations,
> starting with ZAOstock (Maine, Oct 2026) and Zaoville. If you build live culture, or want to sponsor it,
> let's talk: zaal@thezao.com.
